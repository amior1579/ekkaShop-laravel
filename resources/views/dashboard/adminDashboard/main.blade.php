...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-light ec-header-light" id="body">
    ...
    <div class="wrapper">
        ...
        <!-- LEFT MAIN SIDEBAR -->
        @include('dashboard.adminDashboard.layouts.sidebar.left_main_sidebar')

        <!--  PAGE WRAPPER -->
        <div class="ec-page-wrapper">

            <!-- Header start  -->
            @include('dashboard.adminDashboard.layouts.header.header')
            <!-- Header End  -->
            ...
            <!-- Footer Start -->
            @include('dashboard.adminDashboard.layouts.footer.footer')
            <!-- Footer Area End -->
